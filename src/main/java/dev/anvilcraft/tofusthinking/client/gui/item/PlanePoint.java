...
public class PlanePoint {
    ...
    public static PlanePoint ENERGY_BAR_START = create(2,12);
    public static PlanePoint ENERGY_BAR_END = create(3,2);
    public static PlanePoint ENERGY_BACKGROUND_END = create(4,2);
